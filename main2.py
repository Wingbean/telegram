...
def main():
    ...
    #send_report_to_telegram(df1, "รายงาน HN ไม่มีวันลงทะเบียน", "NCD")
    ...
    #send_report_to_telegram(df2, "ผู้มาบริการแยกแผนก", "test")
    send_dataframe_as_image(df2, "ผู้มาใช้บริการแยกแผนก", "NCD")
    #send_report_to_line(df2, "ผู้มาใช้บริการแยกแผนก", "me")
    #send_dataframe_as_line_flex(df2, "ผู้มาใช้บริการแยกแผนก", "me")

    #df3 = fetch_count_admit()
    #send_report_to_telegram(df3, "จำนวนผู้ป่วย Admit", "test")
    #send_dataframe_as_image(df3, "จำนวนผู้ป่วย Admit", "NCD")

    df4 = fetch_ward_status()
    #send_report_to_telegram(df4, "สถานะเตียง", "test")
    send_dataframe_as_image(df4, "สถานะเตียง", "NCD")
